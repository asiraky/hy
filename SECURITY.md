...
[private vulnerability reporting](https://github.com/asiraky/omniplex/security/advisories/new)
to send a report to the maintainer.
...
Only the latest revision of `main` is currently supported with security fixes.
